...
async function seed() {
  try {
    ...
    // Create Faculty Accounts & Profiles
    const facultyData = [
    ...
    // Create Subjects based on Timetable image
    const subjectsList = [
    ...
    // Define timetable classes based on image
    const classesToCreate = [
      ...
      // Friday (contains Prompt Engineering Lab)
    ...
    // Create Student User (Rahul Kumar)
    ...
    // Generate Attendance Records for last 10 days
    ...
    console.log('\n✅ SVIET Database seeded successfully!');
    console.log('\nDemo Accounts:');
    console.log('  Admin:   admin@frscollege.com / Admin@123');
    console.log('  Faculty: faculty@frscollege.com / Faculty@123');
    console.log('  Student: student@frscollege.com / Student@123');
